...
{
    public class Serialized_WeaponSpawner : MonoBehaviour
    {
...
#if UNITY_EDITOR
        [CustomEditor(typeof(Serialized_WeaponSpawner))]
        public class Local_WeaponSpawnerEditor : Editor
        {
            Serialized_WeaponSpawner script;
            private void OnEnable()
            {
                script = (Serialized_WeaponSpawner)target;
            }
